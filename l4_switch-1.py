...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        if dpid == 1: # switch S1
            ...
            self.add_layer4_rules(datapath, inet.IPPROTO_UDP, '10.0.0.2', 10, 4)
            self.add_layer4_rules(datapath, inet.IPPROTO_UDP, '10.0.0.4', 10, 4)
...
#            self.add_flow(datapath, 30, match, actions)  
            ...
            #there is no tcp packets flowing on this switch!
            ...
            ### implement udp fwding
            self.add_layer4_rules(datapath, inet.IPPROTO_UDP, '10.0.0.1', 10, 4)
            self.add_layer4_rules(datapath, inet.IPPROTO_UDP, '10.0.0.3', 10, 4)
